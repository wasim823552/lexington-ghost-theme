...
class RecordBatch {
    ...
    setChildAt(index, child) {
        ...
        if (index > -1 && index < this.numCols) {
            ...
            data = (0, data_js_1.makeData)({ type: new type_js_1.Struct(fields), length: data.length, children });
        }
    ...
    select(columnNames) {
        ...
        return new RecordBatch(schema, (0, data_js_1.makeData)({ type, length: this.numRows, children }), this._metadata);
    }
    /**
...
class _InternalEmptyPlaceholderRecordBatch extends RecordBatch {
    constructor(schema, metadata) {
        ...
        const data = (0, data_js_1.makeData)({ type: new type_js_1.Struct(schema.fields), length: 0, nullCount: 0, children });
