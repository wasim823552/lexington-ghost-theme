...
declare abstract class RecordBatchReaderImpl<T extends TypeMap = any> implements RecordBatchReaderImpl<T> {
    ...
    protected _loadDictionaryBatch(header: metadata.DictionaryBatch, body: Uint8Array): Vector<any>;
    protected _loadVectors(header: metadata.RecordBatch, body: Uint8Array, types: (Field | DataType)[]): Data<any>[];
    protected _loadCompressedVectors(header: metadata.RecordBatch, body: Uint8Array[], types: (Field | DataType)[]): Data<any>[];
...
declare class RecordBatchJSONReaderImpl<T extends TypeMap = any> extends RecordBatchStreamReaderImpl<T> {
    ...
    protected _loadVectors(header: metadata.RecordBatch, body: any, types: (Field | DataType)[]): Data<any>[];
}
export {};
