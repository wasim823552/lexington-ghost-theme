...
const body_compression_js_1 = require("../../fb/body-compression.js");
const body_compression_method_js_1 = require("../../fb/body-compression-method.js");
...
class Message {
    ...
    static encode(message) {
        ...
        const customMetadataOffset = !(message.metadata && message.metadata.size > 0) ? -1 :
            message_js_1.Message.createCustomMetadataVector(b, [...message.metadata].map(([k, v]) => {
        ...
        if (customMetadataOffset !== -1) {
            message_js_1.Message.addCustomMetadata(b, customMetadataOffset);
        }
    ...
    static from(header, bodyLength = 0) {
        ...
        if (header instanceof RecordBatch) {
            return new Message(bodyLength, enum_js_1.MetadataVersion.V5, enum_js_1.MessageHeader.RecordBatch, header, header.metadata);
        }
...
function decodeVariadicBufferCounts(batch) {
    ...
    for (let i = 0; i < length; ++i) {
        counts.push((0, bigint_js_1.bigIntToNumber)(batch.variadicBufferCounts(i)));
    }
    return counts;
}
/** @ignore */
...
function encodeRecordBatch(b, recordBatch) {
    ...
    if (variadicBufferCounts.length > 0) {
        variadicBufferCountsOffset = record_batch_js_1.RecordBatch.createVariadicBufferCountsVector(b, variadicBufferCounts.map(BigInt));
    }
    ...
    if (recordBatch.compression !== null && bodyCompressionOffset) {
        record_batch_js_1.RecordBatch.addCompression(b, bodyCompressionOffset);
    }
    if (variadicBufferCountsOffset !== -1) {
        record_batch_js_1.RecordBatch.addVariadicBufferCounts(b, variadicBufferCountsOffset);
    }
