...
const largebinary_js_1 = require("../builder/largebinary.js");
...
const largelist_js_1 = require("../builder/largelist.js");
...
const largeutf8_js_1 = require("../builder/largeutf8.js");
const binaryview_js_1 = require("../builder/binaryview.js");
const utf8view_js_1 = require("../builder/utf8view.js");
/** @ignore */
class GetBuilderCtor extends visitor_js_1.Visitor {
    ...
    visitLargeList() { return largelist_js_1.LargeListBuilder; }
    ...
    visitIntervalMonthDayNano() { return interval_js_1.IntervalMonthDayNanoBuilder; }
    ...
    visitBinaryView() { return binaryview_js_1.BinaryViewBuilder; }
    visitUtf8View() { return utf8view_js_1.Utf8ViewBuilder; }
}
