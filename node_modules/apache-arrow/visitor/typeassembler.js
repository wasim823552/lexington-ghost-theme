...
const binary_view_js_1 = require("../fb/binary-view.js");
const large_binary_js_1 = require("../fb/large-binary.js");
const bool_js_1 = require("../fb/bool.js");
const utf8_js_1 = require("../fb/utf8.js");
const utf8_view_js_1 = require("../fb/utf8-view.js");
const large_utf8_js_1 = require("../fb/large-utf8.js");
...
const large_list_js_1 = require("../fb/large-list.js");
...
class TypeAssembler extends visitor_js_1.Visitor {
    ...
    visitBinaryView(_node, b) {
        binary_view_js_1.BinaryView.startBinaryView(b);
        return binary_view_js_1.BinaryView.endBinaryView(b);
    }
    ...
    visitUtf8View(_node, b) {
        utf8_view_js_1.Utf8View.startUtf8View(b);
        return utf8_view_js_1.Utf8View.endUtf8View(b);
    }
    ...
    visitLargeList(_node, b) {
        large_list_js_1.LargeList.startLargeList(b);
        return large_list_js_1.LargeList.endLargeList(b);
    }
    visitStruct(_node, b) {
