...
const getUtf8ViewValue = (data, index) => {
    ...
    return (0, utf8_js_1.decodeUtf8)(bytes);
};
...
const getList = (data, index) => {
    ...
    const begin = (0, bigint_js_1.bigIntToNumber)(valueOffsets[index * stride]);
    const end = (0, bigint_js_1.bigIntToNumber)(valueOffsets[index * stride + 1]);
...
/* istanbul ignore next */
/** @ignore */
const getInterval = (data, index) => (data.type.unit === enum_js_1.IntervalUnit.MONTH_DAY_NANO)
