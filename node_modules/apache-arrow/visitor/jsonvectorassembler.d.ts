...
import { DataType, Float, Int, Date_, Interval, Time, Timestamp, Union, Duration, Bool, Null, Utf8, LargeUtf8, Binary, LargeBinary, BinaryView, Utf8View, Decimal, FixedSizeBinary, List, LargeList, FixedSizeList, Map_, Struct, IntArray } from '../type.js';
/** @ignore */
export interface JSONVectorAssembler extends Visitor {
    ...
    visitBinaryView<T extends BinaryView>(data: Data<T>): {
        VIEWS: any[];
        VARIADIC_DATA_BUFFERS: string[];
    };
    visitUtf8View<T extends Utf8View>(data: Data<T>): {
        VIEWS: any[];
        VARIADIC_DATA_BUFFERS: string[];
    };
    ...
    visitLargeList<T extends LargeList>(data: Data<T>): {
        children: any[];
        OFFSET: string[];
    };
...
/** @ignore */
export declare function bigNumsToStrings(values: BigUint64Array | BigInt64Array | Uint32Array | Int32Array | IntArray, stride: number): Generator<string, void, unknown>;
