...
export declare class VectorLoader extends Visitor {
    ...
    private nodesIndex;
    private buffers;
    protected buffersIndex: number;
    private dictionaries;
    private readonly metadataVersion;
    private variadicBufferCounts;
    private variadicBufferIndex;
    constructor(bytes: Uint8Array, nodes: FieldNode[], buffers: BufferRegion[], dictionaries: Map<number, Vector<any>>, metadataVersion?: MetadataVersion, variadicBufferCounts?: number[]);
    ...
    visitUtf8View<T extends type.Utf8View>(type: T, { length, nullCount }?: FieldNode): Data<T>;
    ...
    visitBinaryView<T extends type.BinaryView>(type: T, { length, nullCount }?: FieldNode): Data<T>;
    ...
    visitLargeList<T extends type.LargeList>(type: T, { length, nullCount }?: FieldNode): Data<T>;
    ...
    protected readVariadicBuffers(length: number): Uint8Array[];
    protected nextVariadicBufferCount(): number;
...
export declare class CompressedVectorLoader extends VectorLoader {
    private bodyChunks;
    ...
    protected readData<T extends DataType>(_type: T, _buffer?: BufferRegion): Uint8Array;
}
