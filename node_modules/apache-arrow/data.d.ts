...
/** @ignore */
declare const kDataSymbol: unique symbol;
/** @ignore */
...
export declare class Data<T extends DataType = DataType> {
    ...
    readonly variadicBuffers: ReadonlyArray<Uint8Array>;
    get typeId(): T['TType'];
    ...
    constructor(type: T, offset: number, length: number, nullCount?: number, buffers?: Partial<Buffers<T>> | Data<T>, children?: Data[], dictionary?: Vector, variadicBuffers?: ReadonlyArray<Uint8Array>);
    getValid(index: number): boolean;
    setValid(index: number, value: boolean): boolean;
    clone<R extends DataType = T>(type?: R, offset?: number, length?: number, nullCount?: number, buffers?: Buffers<R>, children?: Data[], variadicBuffers?: ReadonlyArray<Uint8Array>): Data<R>;
...
import { Dictionary, Bool, Null, Utf8, Utf8View, LargeUtf8, Binary, BinaryView, LargeBinary, Decimal, FixedSizeBinary, List, LargeList, FixedSizeList, Map_, Struct, Float, Int, Date_, Interval, Duration, Time, Timestamp, Union, DenseUnion, SparseUnion } from './type.js';
/** @ignore */
...
interface DurationDataProps<T extends Duration> extends DataProps_<T> {
    data?: DataBuffer<T>;
}
...
interface BinaryViewDataProps<T extends BinaryView> extends DataProps_<T> {
    views: DataBuffer<T>;
    variadicBuffers?: ReadonlyArray<ArrayLike<number> | Iterable<number> | Uint8Array>;
    data?: DataBuffer<T>;
}
interface LargeBinaryDataProps<T extends LargeBinary> extends DataProps_<T> {
    valueOffsets: LargeValueOffsetsBuffer | ValueOffsetsBuffer;
    data?: DataBuffer<T>;
}
...
interface Utf8ViewDataProps<T extends Utf8View> extends DataProps_<T> {
    views: DataBuffer<T>;
    variadicBuffers?: ReadonlyArray<ArrayLike<number> | Iterable<number> | Uint8Array>;
    data?: DataBuffer<T>;
}
...
interface LargeListDataProps<T extends LargeList> extends DataProps_<T> {
    valueOffsets: LargeValueOffsetsBuffer | ValueOffsetsBuffer;
    child: Data<T['valueType']>;
}
...
export declare function makeData<T extends Duration>(props: DurationDataProps<T>): Data<T>;
export declare function makeData<T extends FixedSizeBinary>(props: FixedSizeBinaryDataProps<T>): Data<T>;
export declare function makeData<T extends BinaryView>(props: BinaryViewDataProps<T>): Data<T>;
export declare function makeData<T extends Binary>(props: BinaryDataProps<T>): Data<T>;
export declare function makeData<T extends LargeBinary>(props: LargeBinaryDataProps<T>): Data<T>;
export declare function makeData<T extends Utf8>(props: Utf8DataProps<T>): Data<T>;
export declare function makeData<T extends LargeUtf8>(props: LargeUtf8DataProps<T>): Data<T>;
export declare function makeData<T extends Utf8View>(props: Utf8ViewDataProps<T>): Data<T>;
export declare function makeData<T extends List>(props: ListDataProps<T>): Data<T>;
export declare function makeData<T extends LargeList>(props: LargeListDataProps<T>): Data<T>;
