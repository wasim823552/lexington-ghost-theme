...
const binary_view_js_1 = require("./binary-view.js");
...
const large_list_view_js_1 = require("./large-list-view.js");
const large_utf8_js_1 = require("./large-utf8.js");
const list_js_1 = require("./list.js");
const list_view_js_1 = require("./list-view.js");
...
const utf8_view_js_1 = require("./utf8-view.js");
/**
 * ----------------------------------------------------------------------
...
function unionToType(type, accessor) {
    switch (Type[type]) {
        ...
        case 'BinaryView': return accessor(new binary_view_js_1.BinaryView());
        case 'Utf8View': return accessor(new utf8_view_js_1.Utf8View());
        case 'ListView': return accessor(new list_view_js_1.ListView());
        case 'LargeListView': return accessor(new large_list_view_js_1.LargeListView());
        default: return null;
    }
}
...
function unionListToType(type, accessor, index) {
    switch (Type[type]) {
        ...
        case 'BinaryView': return accessor(index, new binary_view_js_1.BinaryView());
        case 'Utf8View': return accessor(index, new utf8_view_js_1.Utf8View());
        case 'ListView': return accessor(index, new list_view_js_1.ListView());
        case 'LargeListView': return accessor(index, new large_list_view_js_1.LargeListView());
        default: return null;
    }
}
