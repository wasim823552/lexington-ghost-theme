...
export declare const util: {
    ...
    isArrowSchema(x: any): x is import("./schema.js").Schema<any>;
    isArrowField(x: any): x is import("./schema.js").Field<any>;
    isArrowDataType(x: any): x is import("./type.js").DataType<import("./enum.js").Type, any>;
    isArrowData(x: any): x is import("./data.js").Data<import("./type.js").DataType<import("./enum.js").Type, any>>;
    isArrowVector(x: any): x is import("./vector.js").Vector<any>;
    isArrowRecordBatch(x: any): x is import("./recordbatch.js").RecordBatch<any>;
    isArrowTable(x: any): x is import("./table.js").Table<any>;
    toIntervalDayTimeInt32Array(objects: util_interval_.IntervalDayTimeObject[]): Int32Array;
    toIntervalMonthDayNanoInt32Array(objects: Partial<util_interval_.IntervalMonthDayNanoObject<false>>[]): Int32Array;
