 ...
 */
export declare function _setConnectionAttributes(span: Span, connectionContext: PostgresConnectionContext | undefined): void;
/**
 * Extracts DB operation name from SQL query and sets it on the span.
 *
 * @internal Exported for the orchestrion (diagnostics-channel) integration.
 */
export declare function _setOperationName(span: Span, sanitizedQuery: string | undefined, command?: string): void;
/**
