...
import { type AsyncLocalStorageLookup, type OpenTelemetryTracerProvider } from '@sentry/opentelemetry';
...
export declare function setupOtel(client: NodeClient, options?: AdditionalOpenTelemetryOptions): [OpenTelemetryTracerProvider | undefined, AsyncLocalStorageLookup | undefined];
/** Just exported for tests. */
